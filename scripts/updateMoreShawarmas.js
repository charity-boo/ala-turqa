...
async function run() {
  ...
  const mapping = [
    { nameQuery: 'Shawarma Plate + Fries + Rice + Salad', file: 'shawarma fries and salad.webp' },
    { nameQuery: 'Shawarma Plate + Fries or Rice + Salad + 500ml Soda', file: 'shawarma fries and salad.webp' }, // Might as well set it here too if it fits
    { nameQuery: 'Shawarma + Fries + 350ml Soda', file: 'shawarma fries and soda.webp' },
    { nameQuery: 'Shawarma Wrap + Fries + 350ml Soda', file: 'shawarma fries and soda.webp' }
  ];

  for (const map of mapping) {
    const item = items.find(i => i.name === map.nameQuery);
