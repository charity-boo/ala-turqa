...
async function run() {
  ...
  const mapping = [
    { nameQuery: 'grilled kofte', file: 'grilled kofte.jpeg' },
    { nameQuery: 'lamb chops', file: 'lamb chops.jpeg' },
    { nameQuery: 'mixed grill', file: 'mixed grill.jpeg' },
    { nameQuery: 'fried wings', file: 'Fried wings.jpg' }
  ];
