...
async function run() {
  ...
  const mapping = [
    { nameQuery: 'fried chicken x 1 piece', file: 'fried chicken 1 piece.jpg' },
    { nameQuery: 'fried chicken x 3 piece', file: 'fried chicken 3 pieces.jpeg' },
    { nameQuery: 'fried wings', file: 'fried wings.webp' },
    { nameQuery: 'chicken schnitzel', file: 'Chicken Schnitzel.jpeg' },
    { nameQuery: 'chicken shish', file: 'chicken shish.jpg' },
  ];
  ...
  for (const map of mapping) {
    ...
    if (item) {
      ...
      console.log(`Item not found for ${map.nameQuery}`);
    }
  }
